...
export default function StepComponent({ steps, selectedStep, setSelectedStep }) {
            ...
            <div className="flex flex-col gap-5">
                {steps.map((step, index) => (
                    ...
                    >
                        ...
                        >
                            <div className="text-sm md:text-2xl font-bold">{step.title}</div>
                            <div className="text-sm font-medium md:text-xl text-start">{step.description}</div>
                        </div>
                    </div>
                ))}
            </div>
