  ...
  return (
    <div>
      <img
        src={Wave1}
        alt="wave"
        className="absolute w-full top-[1500px] h-[1700px] "></img>
      <img
        src={Wave2}
        alt="wave"
        className="absolute w-full top-[2600px] h-[1700px]"></img>

      <div className="relative flex flex-col justify-center mt-52 w-full px-4 mx-auto lg:w-4/5">
