    ...
    const steps = [
        {
            title: 'OT',
            description:
                '새로운 기수를 시작하며, 다양한 활동 방법을 소개하는 세션',
        },
        {
            title: 'MT',
        ...
        },
        {
            title: '테버랜드',
            description:
                'OB와 YB가 다양한 콘텐츠 내에서 활동하며 네트워킹하는 세션',
        },
        {
            title: '전반기 시상식',
        ...
        },
        {
            title: '테런데이',
            description:
                '다양한 멘토들에게 직접 프로젝트 피드백을 받을 수 있는 세션',
        },
        {
            title: 'OB 강연',
            description:
        ...
        },
        {
            title: '테이브의 밤',
            description:
                '매 회 다른 컨셉을 두고, 전 기수가 모이는 네트워킹 센터',
        },
        {
            title: 'TAVE 컨퍼런스',
            description:
            ...
            <div className="absolute z-30 flex flex-col gap-[60px] items-center px-4 w-full h-full top-[640px]">
                ...
                <div className="px-[188px] py-[30px] bg-[#232323] rounded-[20px]">
                    <div className="text-center text-xl font-bold">
                        다양성을 존중하며 협력하는 IT에 관심있는 대학생 누구나
                        지원 가능합니다.
                    </div>
                </div>
            </div>
