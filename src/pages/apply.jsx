            ...
            <div className="flex flex-col gap-[86px] mt-[200px] items-center z-30">
                ...
                <div className="relative flex items-center z-30">
                    <input
                        ...
                        py-7 pl-[50px] text-2xl placeholder-[#868b94] w-[807px] pr-[230px]"
                    />
                    <button
                        className="absolute right-0 bg-white px-[33px] py-7 rounded-[80px] border
                        border-[#868b94] text-black text-2xl font-bold"
                    >
                        알림 신청하기
                    </button>
                </div>
            </div>
            <img className="absolute inset-0 z-10" src={wave} alt="wave" />
            <Footer />
        </>
    );
}
