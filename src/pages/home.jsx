...
export default function HomeTest() {
    ...
    const [innerWidth, setInnerWidth] = useState(window.visualViewport.width <= 758);
    ...
    return (
        ...
        <div className="outer relative mx-auto break-keep" ref={outerDivRef}>
            ...
            <div className="flex flex-col justify-center items-center w-full">
                {/* 첫번째 화면 */}
                <div
                    className="flex flex-col items-center h-screen justify-center w-screen md:px-20 px-5"
                    style={{
                ...
                {/* 웹에서는 이 문구가 따로 */}
                <div
                    className="hidden md:flex h-screen w-full flex-col items-center justify-center w-screen md:px-20 px-5"
                    style={{
                ...
                {/*세번째 화면 */}
                <div className="h-screen w-full flex flex-col justify-center items-center  md:px-20 px-5">
                ...
                {/*네번째 화면 */}
                <div className="h-screen flex flex-col justify-center items-center w-full  md:px-20 px-5">
                ...
                {/*다섯번째 화면 */}
                <div className="realtive h-screen flex flex-col w-full">
