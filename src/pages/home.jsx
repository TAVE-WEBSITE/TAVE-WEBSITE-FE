...
import ArrowDown from "../assets/images/homeArrowDown.svg"
    ...
    <div className="relative overflow-y-auto">
      ...
      <div className="flex flex-col justify-center items-center w-full px-20 ">
        <div className="flex flex-col items-center h-screen justify-center h-screen">
          <div className="text-base DMSans">The new technology wave,</div>
          <img src={LogoTave} className="lg:w-80 w-56" alt="taveLogo"></img>
          <div className="lg:text-4xl text-2xl font-medium mt-10 text-center">
        ...
        <div className="h-screen w-full flex flex-col items-center justify-center ">
          <p className="font-bold text-center lg:  mb-20">
          <span className="hidden sm:inline text-4xl leading-[58px]">
    다양한 분야와의 융합을 통해 미래를 선도하는 <br /> IT 연합 동아리, TAVE를 소개합니다
  </span>
  <span className="inline sm:hidden font-semibold text-xl leading-6">
    다양한 분야와의 융합을 통해 <br /> 미래를 선도하는 IT 연합 동아리, <br /> TAVE를 소개합니다
                      </span>
                      <img src={ArrowDown} className="sm:hidden mx-auto mt-12" alt="ArrowDown"></img>
          </p>
